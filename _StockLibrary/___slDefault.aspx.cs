    ...
    public partial class _slDefault : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                this.Session["STOCKLIBRARY_LIST__DATASOURCE"] = null;
        ...
        private void ___Get__GridView_DS()
        {
            try
            {
                ...
                {
                    using (DataTable __dt = __xips.getDetailedList(XipsDAL.DataType.StockLibrary))
                    {
                        this.Session["STOCKLIBRARY_LIST__DATASOURCE"] = __dt.DefaultView;
        ...
        private bool ___Bind__GridView_DS()
        {
            ...
            try
            {
                ...
                if (this.Session["STOCKLIBRARY_LIST__DATASOURCE"].GetType() != typeof(DataView))
                {
                    this.___Get__GridView_DS();
                }

                DataView ___dv = this.Session["STOCKLIBRARY_LIST__DATASOURCE"] as DataView;
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                e.Row.Cells[5].Width = Unit.Pixel(90);
            }
