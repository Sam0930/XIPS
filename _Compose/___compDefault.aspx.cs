...
{
    public partial class ____compDefault : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                this.Session["COMPOSEMASTER_LIST__DATASOURCE"] = null;
        ...
        private void ___Get__GridView_DS()
        {
            try
            {
                ...
                {
                    using (DataTable __dt = __xips.getDetailedList(XipsDAL.DataType.ComposeMaster))
                    {
                        this.Session["COMPOSEMASTER_LIST__DATASOURCE"] = __dt.DefaultView;
        ...
        private bool ___Bind__GridView_DS()
        {
            ...
            try
            {
                ...
                if (this.Session["COMPOSEMASTER_LIST__DATASOURCE"].GetType() != typeof(DataView))
                {
                    this.___Get__GridView_DS();
                }

                DataView ___dv = this.Session["COMPOSEMASTER_LIST__DATASOURCE"] as DataView;
